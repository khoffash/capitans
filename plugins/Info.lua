--Begin info.lua By @khoffash
local Solid = 140936305
...
local function info_cb(arg, data)
  ...
  lastname = ""
   ...
   local text = "_ƒιяѕт ηαмє :_ *"..firstname.."*\n_ℓαѕт ηαмє :_ *"..lastname.."*\n_υѕєяηαмє :_ "..username.."\n_ι∂ :_ *"..data.id_.."*\n\n"
		    if data.id_ == tonumber(Solid) then
		       text = text..'_яαηк :_ *єχєcυтινє α∂мιη*\n\n'
  ...
  text = text..'тσтαℓ мєѕѕαgєѕ : '..user_info_msgs..'\n\n'
  text = text..'@capitans'
